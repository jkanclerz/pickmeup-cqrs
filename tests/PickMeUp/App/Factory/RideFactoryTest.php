...
class RideFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function getRideRequestCommandMock()
    {
        ...
        $rideRequestCommand->method('getRideId')->willReturn($this->getMockBuilder(RideId::class)->disableOriginalConstructor()->getMock());
        $rideRequestCommand->method('getRequesterId')->willReturn($this->getMockBuilder(UserId::class)->disableOriginalConstructor()->getMock());
